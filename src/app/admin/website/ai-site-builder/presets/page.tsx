  ...
  return (
    <div className="px-5 py-4">
      ...
      <div className="max-w-3xl space-y-4">
        {MODES.map((m) => (
          <div key={m.id} className="overflow-hidden rounded-sm border border-[#c3c4c7] bg-white">
            <div className="border-b border-[#c3c4c7] bg-[#f6f7f7] px-4 py-2.5">
              <h2 className="text-[14px] font-semibold text-[#1d2327]">{m.label}</h2>
              <p className="text-[12px] text-[#50575e]">{m.blurb}</p>
            </div>
            <pre className="max-h-96 overflow-auto whitespace-pre-wrap px-4 py-3 text-[12px] leading-snug text-[#1d2327]">
