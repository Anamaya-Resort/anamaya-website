  ...
  return (
    <div className="flex shrink-0 items-center gap-2">
      ...
      <button
        ...
        className="inline-flex items-center gap-1 rounded-full border border-zinc-300 bg-white px-3 py-2 text-[11px] font-semibold uppercase tracking-wider text-anamaya-charcoal hover:bg-zinc-50"
