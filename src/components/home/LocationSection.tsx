  ...
  return (
    <section className="bg-white px-6 py-20">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        {/* Google Maps embed for Montezuma, Costa Rica */}
        <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-anamaya-charcoal/10">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929.9737934912693!2d-85.07520392462253!3d9.657069779128657!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8fa1aa1c1a1a1a1a%3A0x1!2sMontezuma%2C+Puntarenas%2C+Costa+Rica!5e0!3m2!1sen!2sus!4v1700000000000"
